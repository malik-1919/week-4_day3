...
print(substring) # prints 17 which is the index of r 
substring=text[17:20] # prints RST

# find H-T
substring=text.find("H")
print(substring) # prints 7 which is the index of h 
# find indext of T
substring=text.find("T") # prints 19 whihc is the index of t 
# find h-t
substring=text[7:20]
...
sentence="especically in electronic commmunications, writing in all caps is equivalent to yelling"
...
# find the word "communication" in the sentence
print(sentence.find("commnunication")) # prints 26
...
print(Joined_list) # prints Simple is way better than complex
#this will join the list into a string with a space
# between each word

#split a string into a list
sentence="if the implementation is hard to explain, it might be a bad ideal."
...
sentence4="If the implemation is hard to explain,it might be a bad idea"
